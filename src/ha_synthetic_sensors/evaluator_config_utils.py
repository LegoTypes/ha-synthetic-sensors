...
class EvaluatorConfigUtils:
    ...
    def __init__(self, circuit_breaker_config: CircuitBreakerConfig | None = None, retry_config: RetryConfig | None = None) -> None:
    ...
    def get_cache_stats(self, cache_handler: Any, error_handler: Any) -> CacheStats:
    ...
    def clear_compiled_formulas(self, enhanced_helper: Any) -> None:
    ...
    def get_compilation_cache_stats(self, build_stats_func: Any, enhanced_helper: Any) -> dict[str, Any]:
    ...
    def get_enhanced_evaluation_stats(self, get_stats_func: Any, enhanced_helper: Any) -> dict[str, Any]:
    ...
    def start_update_cycle(self, cache_handler: Any) -> None:
        """Start new evaluation update cycle."""
        cache_handler.start_update_cycle()

    def end_update_cycle(self, cache_handler: Any) -> None:
        """End current evaluation update cycle."""
        cache_handler.end_update_cycle()

    def clear_cache(self, cache_handler: Any, formula_name: str | None = None) -> None:
