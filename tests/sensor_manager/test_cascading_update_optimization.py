...
class TestCascadingUpdateOptimization:
    ...
    def sensor_configs(self):
        ...
        return [
            SensorConfig(
                ...
                formulas=[
                    FormulaConfig(
                        id="spa_power_formula", formula="state('sensor.span_backing_spa_power')", name="spa_power_formula"
                    )
                ],
            ),
            SensorConfig(
    ...
    async def test_optimized_update_only_invalidates_backing_entities(self, mock_invalidate, sensor_manager):
    ...
    @patch.object(ReferenceValueManager, "invalidate_entities")
    async def test_optimization_prevents_double_processing(self, mock_invalidate, sensor_manager):
