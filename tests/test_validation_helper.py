...
class TestConvertToNumeric:
    ...
    def test_convert_to_numeric_none(self):
        ...
        assert "Entity 'test.entity' has None state - cannot convert to number" in str(exc_info.value)
    ...
    def test_convert_to_numeric_non_numeric_string(self):
        ...
        assert "Entity 'test.entity' state 'on' cannot be converted to number" in str(exc_info.value)
    ...
    def test_convert_to_numeric_empty_string(self):
        ...
        assert "Entity 'test.entity' state '' cannot be converted to number" in str(exc_info.value)
    ...
    def test_convert_to_numeric_list(self):
        ...
        assert "Entity 'test.entity' state '[1, 2, 3]' cannot be converted to number" in str(exc_info.value)
    ...
    def test_convert_to_numeric_dict(self):
        ...
        assert "Entity 'test.entity' state '{'value': 42}' cannot be converted to number" in str(exc_info.value)
