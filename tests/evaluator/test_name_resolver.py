...
class TestNameResolver:
    ...
    def test_is_valid_entity_id(self, mock_hass, mock_entity_registry, mock_states):
        ...
        # Valid entity IDs
        assert resolver.is_valid_entity_id("sensor.temperature") is True
        ...
        assert resolver.is_valid_entity_id("too.many.dots") is False
        assert resolver.is_valid_entity_id(".no_domain") is False
        assert resolver.is_valid_entity_id("domain.") is False
