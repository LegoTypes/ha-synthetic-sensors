...
class TestTypeSafeEvaluationContext:
    ...
    def test_set_variable_with_reference(self) -> None:
        ...
        with patch("ha_synthetic_sensors.type_safe_context.ReferenceValueManager.set_variable_with_reference_value") as mock_set:
    ...
    def test_to_evaluation_context(self) -> None:
        ...
        with patch("ha_synthetic_sensors.type_safe_context.ReferenceValueManager.convert_to_evaluation_context") as mock_convert:
